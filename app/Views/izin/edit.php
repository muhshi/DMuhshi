    ...
    <div class="col-md-12">
        <div class="tile">
            ...
            <div class="tile-body col-md-11">
                ...
                <form action="<?= base_url('/izin/update/' . $izin->id); ?>" method="post" autocomplete="off">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?= isset($errors['keperluan']) ? 'is-invalid' : null; ?>" rows="4" name="keperluan" placeholder="Isikan keperluan mengajukan perizinan"><?= old('keperluan', $izin->keperluan); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                Pergi <input class="form-control <?= isset($errors['jam_pergi']) ? 'is-invalid' : null; ?>" value="<?= old('jam_pergi', $izin->jam_pergi); ?>" type="time" name="jam_pergi">
                                <div class="invalid-feedback">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                Kembali <input class="form-control <?= isset($errors['jam_balik']) ? 'is-invalid' : null; ?>" value="<?= old('jam_balik', $izin->jam_balik); ?>" type="time" name="jam_balik">
                                <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?= isset($errors['atas_izin']) ? 'is-invalid' : null; ?>" name="atas_izin">
                            ...
                            <?php foreach ($atasan as $atas) : ?>
                                <option value="<?= $atas->id; ?>" <?= old('id', $atas->id) == $atas->id ? 'selected' : null ?>>
                                    <?= $atas->nama_atasan; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
